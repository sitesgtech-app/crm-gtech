...
const initialData: DB = {
  ...
  services: [
    { id: 's1', name: 'Implementación CRM', description: 'Configuración y capacitación', price: 5000, active: true },
    { id: 's2', name: 'Soporte Técnico Mensual', description: 'SLA 24/7', price: 800, active: true }
  ],
  inventoryItems: [
