                    ...
                    <div key={p.id} className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-md transition-all group">
                        <div className="p-5 border-b border-slate-100 relative">
                            <div className="flex justify-between items-start mb-2">
                                <span className={`text-[10px] uppercase font-bold px-2 py-0.5 rounded border ${p.status === ProjectStatus.EN_EJECUCION ? 'bg-blue-50 text-blue-700 border-blue-200' :
                        ...
                        <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50 rounded-t-xl">
                            <div>
                                ...
                                <div className="flex items-center gap-2 mt-1">
                                    <span className={`text-xs font-bold px-2 py-0.5 rounded border ${currentProject.status === ProjectStatus.EN_EJECUCION ? 'bg-blue-100 text-blue-700 border-blue-200' :
