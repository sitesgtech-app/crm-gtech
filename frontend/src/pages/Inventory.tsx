                ...
                {tabConfig.map((tab) => {
                    ...
                    return (
                        <button
                            ...
                            className={`flex items-center px-5 py-3 rounded-xl text-sm font-bold transition-all duration-300 transform hover:scale-[1.02] ${isActive ? tab.activeColor : `${tab.color} opacity-70 hover:opacity-100`
                                }`}
                        >
                        ...
                        {activeTab === 'Productos para la Venta' ? (
                            ...
                            filteredInternal.map((item) => (
                                <tr key={item.id} className="hover:bg-slate-50/80 transition-colors group">
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-3">
                                            <div className={`p-2.5 rounded-lg ${activeTab === 'Insumos' ? 'bg-emerald-50 text-emerald-600' :
