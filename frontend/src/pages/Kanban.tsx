                            ...
                            <div className="p-6 border-b border-slate-100 flex justify-between sticky top-0 bg-white z-10 items-center">
                                ...
                                <div className="flex gap-2 items-center">
                                    {newOpp.id && (
                                        <button
                                            type="button"
                                            onClick={() => handleOpenQuotation(opportunities.find(o => o.id === newOpp.id)!)}
                                            className="text-brand-600 hover:text-brand-800 mr-2 p-2 hover:bg-brand-50 rounded-full transition-colors"
                    ...
                    <div className="fixed inset-0 bg-black/50 flex items-center justify-end z-50 transition-all duration-300 backdrop-blur-sm">
                        <div className="w-full md:w-[600px] h-full bg-white shadow-2xl flex flex-col animate-slide-left">
                            ...
                            <div className="p-4 border-t border-slate-100 bg-slate-50 flex gap-3">
                                <button
                                    onClick={() => handleOpenQuotation(selectedOpp)}
                                    className="px-4 py-2.5 bg-white border border-brand-200 text-brand-700 font-bold rounded-xl hover:bg-brand-50 transition-colors shadow-sm flex items-center justify-center gap-2"
                                    title="Generar Cotización"
                                >
                                    <FileText size={18} />
                                </button>
